...
class GeSHi {
     ...
     * @var int
     */
    var $header_type = GESHI_HEADER_NONE;
     ...
     */
    var $important_styles = 'font-weight: normal; color: red;'; // Styles for important parts of the code
     ...
     * @var string
     */
    var $code_style = 'font-family: Lucida Console, monospace; font-weight: normal; font-size: 14px;';
     ...
     * @var string
     */
    var $line_style1 = 'font-family: Lucida Console, Courier, monospace; color: #000000; font-weight: normal; font-style: normal; font-size: 14px;';

    /**
     * Line number styles for fancy lines
     * @var string
     */
    var $line_style2 = 'font-weight: normal;';
	 ...
	 * @var int
	 */
	var $use_language_tab_width = true;
     ...
     * @since 1.0.0
     */
    function GeSHi($source, $language, &$lc, $n, $path = '') {
        $this->set_source($source);
        $this->set_language_path($path);
        $this->set_language($language);
        $this->enable_line_numbers (GESHI_NORMAL_LINE_NUMBERS);
        $this->start_line_numbers_at ($n - 1);
        $lc = $this->parse_code ();
    }
