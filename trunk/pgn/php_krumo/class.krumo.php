...
This is a list of all HTTP request headers.
	...
	*/
	Public Static Function phpini() {
		...
		?>
<div class="krumo-title">
This is a list of the configuration settings read from <?php echo get_cfg_var('cfg_file_path');?>.
</div>
		<?php
...
This is a list of all the values from the $_GET array.
		...
		<?php
		return krumo::dump($_GET->toArray ());
		}
	...
	*/
	Public Static Function post() {
		...
		?>
<div class="krumo-title">
This is a list of all the values from the <code>$_POST</code> array.
</div>
		<?php
	...
	*/
	Public Static Function server() {
		...
		?>
<div class="krumo-title">
This is a list of all the values from the <code>$_SERVER</code> array.
</div>
		<?php
...
This is a list of all the values from the $_SESSION array.
	...
	*/
	Public Static Function ini($ini_file) {
		...
		?>
<div class="krumo-title">
This is a list of all the values from the <?php echo realpath($ini_file) ? realpath($ini_file) : $ini_file;?> INI file.
</div>
		<?php
		return krumo::dump($_);
		}
...
<div class="krumo-root">
	<ul class="krumo-node krumo-first">
		...
		<span class="krumo-call" style="white-space:nowrap;">
			Called from <?php echo $d['file']?>,
				line <?php echo $d['line']?></span>
		<?php } ?>
		&nbsp;
		</li>
	</ul>
